...
<html lang="en">
    ...
    <body>
        ...
        <div class="row"> 
                ...
                p = p.findExerciseById(s);

                int id = new Integer(s).intValue();
                session.setAttribute("eId", s);
        ...
        <div class="row"> 
            ...
            <div class="col-md-9 col-sm-9 paddingTop10 grey">
                ...
                <form class="form-horizontal" id="form" name="form" method="post" enctype="multipart/form-data" action="ExerciseServlet">
                    <h1>Update exercise ${Exercises.eName}</h1>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <input type="hidden" name="option" value="updateExercise"/>
                            <input type="submit" name="button" id="button" value="Update"  class="btn btn-primary pull-right"/>
